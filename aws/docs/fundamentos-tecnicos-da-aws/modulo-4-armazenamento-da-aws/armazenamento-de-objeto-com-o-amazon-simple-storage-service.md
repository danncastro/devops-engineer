...
| Armazenamento de Objetos                                                                                                                                                                                                                               | Independência da Computação                                                                                                                                                                                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <mark style="color:purple;">**Descrição**</mark>: O Amazon S3 armazena dados em uma estrutura plana, usando identificadores exclusivos para localizar objetos. Cada objeto é composto por dados (o arquivo) e metadados (informações sobre o arquivo). | <mark style="color:purple;">**Descrição**</mark>: O Amazon S3 não está vinculado a instâncias de computação específicas. Os dados armazenados no S3 podem ser acessados de qualquer lugar na web.            |
| <mark style="color:green;">**Benefício**</mark>: Permite a fácil organização, recuperação e gerenciamento de grandes quantidades de dados sem a complexidade de estruturas hierárquicas.                                                               | <mark style="color:green;">**Benefício**</mark>: Proporciona alta flexibilidade e acessibilidade, permitindo que os dados sejam usados por diferentes serviços e aplicações na nuvem ou em outros ambientes. |

| Escalabilidade Ilimitada                                                                                                                                                                             | Resiliência e Durabilidade                                                                                                                                                                     |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Descrição**</mark>: Você pode armazenar uma quantidade praticamente ilimitada de dados no Amazon S3. Não há limite para o número de objetos que você pode armazenar.   | <mark style="color:purple;">**Descrição**</mark>: O Amazon S3 armazena dados de forma redundante em várias zonas de disponibilidade, garantindo alta durabilidade e disponibilidade dos dados. |
| <mark style="color:green;">**Benefício**</mark>: Ideal para casos de uso que requerem armazenamento de grandes volumes de dados, como backups, repositórios de conteúdo e grandes arquivos de dados. | <mark style="color:green;">**Benefício**</mark>: Proporciona segurança e confiabilidade, assegurando que os dados estejam sempre disponíveis e protegidos contra falhas.                       |

#### <mark style="color:blue;">**Casos de Uso Comuns**</mark>

| Repositório de Dados para Análise                                                                                                                                                         | Distribuição de Conteúdo                                                                                                                            |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Descrição**</mark>: Utilizado como um repositório central para armazenar grandes volumes de dados não estruturados que podem ser analisados posteriormente. | <mark style="color:purple;">**Descrição**</mark>: Pode ser integrado com Amazon CloudFront para distribuir conteúdo globalmente com baixa latência. |
| <mark style="color:green;">**Benefício**</mark>: Facilita a análise de grandes conjuntos de dados usando serviços de análise da AWS, como Amazon Athena e Amazon Redshift.                | <mark style="color:green;">**Benefício**</mark>: Melhora a performance e a disponibilidade do conteúdo para usuários em diferentes partes do mundo. |

| Backup e Recuperação                                                                                                                                                                                     | Armazenamento de Arquivos Estáticos                                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Descrição**</mark>: O Amazon S3 é amplamente utilizado para backup e recuperação de dados devido à sua durabilidade e escalabilidade.                                      | <mark style="color:purple;">**Descrição**</mark>: Ideal para armazenar arquivos estáticos como imagens, vídeos e documentos que precisam ser acessados de forma rápida e eficiente. |
| <mark style="color:green;">**Benefício**</mark>: Proporciona uma solução de backup confiável que pode ser acessada de qualquer lugar, facilitando a recuperação de dados em caso de falhas ou desastres. | <mark style="color:green;">**Benefício**</mark>: Permite a entrega rápida e eficiente de conteúdo para usuários finais, melhorando a experiência do usuário.                        |
...
{% tabs %}
{% tab title="Criando um Bucket" %}
Se você deseja armazenar fotos, pode criar um bucket chamado `meus-arquivos-fotos` na região `us-east-1`.
{% endtab %}

{% tab title="Organização com Pastas" %}
1. Dentro do bucket `meus-arquivos-fotos`, você pode criar uma pasta chamada `2024/Fotos_Viagem` e fazer upload de fotos com nomes como `foto1.jpg`, `foto2.jpg`.
2. O caminho do objeto seria:

<pre class="language-bash"><code class="lang-bash"><strong>http://meus-arquivos-fotos.s3.amazonaws.com/2024/Fotos_Viagem/foto1.jpg
</strong></code></pre>
{% endtab %}
{% endtabs %}
...
| Alta Durabilidade e Disponibilidade                                                  | Escalabilidade e Flexibilidade                                                    |
| ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| Garantia de **99,999999999%** de durabilidade e **99,99%** de disponibilidade anual. | Escalabilidade praticamente ilimitada, permitindo crescer conforme a necessidade. |

| Segurança                                                                    | Economia de Custo                                                                                 |
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Suporte para criptografia de dados e gerenciamento de permissões detalhadas. |  Modelo de pagamento por uso, permitindo economizar ao pagar apenas pelo armazenamento utilizado. |
...
| Muitos Buckets com Diferentes Requisitos de Permissão                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Simplificação**</mark><mark style="color:purple;">:</mark> Em vez de criar e gerenciar múltiplas políticas de bucket do S3, você pode usar políticas do IAM para centralizar e simplificar o gerenciamento de permissões. |
| <mark style="color:purple;">**Eficiência**</mark><mark style="color:purple;">:</mark> Reduz a complexidade de gerenciar várias políticas individuais de bucket, permitindo aplicar permissões de forma consistente e eficiente.                         |

| Gerenciamento Centralizado de Políticas                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <mark style="color:purple;">**Centralização**</mark><mark style="color:purple;">:</mark> Mantendo todas as políticas em um único local centralizado, é mais fácil gerenciar, revisar e auditar as permissões.      |
| <mark style="color:purple;">**Consistência**</mark><mark style="color:purple;">:</mark> Garante que todas as políticas aplicadas estejam de acordo com as práticas de segurança e conformidade da sua organização. |
...
{% tabs %}
{% tab title="Version" %}
Especifica a versão da política. Neste exemplo, a versão é `2012-10-17`
{% endtab %}

{% tab title="Statement" %}
Uma lista de instruções. Cada instrução contém:
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Simplificação**</mark><mark style="color:purple;">:</mark> Permite que outra conta da AWS coloque objetos no seu bucket sem a necessidade de criar funções do IAM. | <mark style="color:purple;">**Leitura Pública**</mark><mark style="color:purple;">:</mark> Permite que qualquer pessoa na internet leia os objetos no bucket. Ideal para hospedar conteúdo público, como sites estáticos ou arquivos de mídia. | <mark style="color:purple;">**Capacidade**</mark><mark style="color:purple;">:</mark> Políticas de buckets do S3 têm um limite de tamanho maior em comparação com políticas do IAM, permitindo gerenciar permissões mais complexas sem atingir os limites de tamanho. |
| <mark style="color:purple;">**Flexibilidade**</mark><mark style="color:purple;">:</mark> Facilita o compartilhamento de acesso entre diferentes contas da AWS de forma simples e direta.         | <mark style="color:purple;">**Granularidade**</mark><mark style="color:purple;">:</mark> Controle granular sobre quem pode executar quais ações nos objetos do bucket.                                                                         |                                                                                                                                                                                                                                                                       |

#### <mark style="color:blue;">**Benefícios das Políticas de Buckets do S3**</mark>

<table><thead><tr><th width="250">Facilidade de Configuração</th><th>Escalabilidade</th><th>Segurança</th></tr></thead><tbody><tr><td>Simples de configurar e gerenciar, especialmente para cenários de acesso público ou entre contas.</td><td>Adequado para ambientes onde as políticas do IAM atingem limites de tamanho.</td><td>Permite aplicar regras de acesso específicas e seguras diretamente aos buckets.</td></tr></tbody></table>
...
| SSE                                                                                                                                                                                                 | CSE                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:green;">**Vantagens**</mark><mark style="color:green;">:</mark> Fácil de configurar e gerenciar; o Amazon S3 cuida de todo o processo de criptografia e gerenciamento de chaves. | <mark style="color:green;">**Vantagens**</mark><mark style="color:green;">:</mark> Controle total sobre o processo de criptografia e as chaves. |
| <mark style="color:purple;">**Desvantagens**</mark><mark style="color:purple;">:</mark> Menor controle sobre o processo de criptografia e as chaves.                                                | <mark style="color:purple;">**Desvantagens**</mark><mark style="color:purple;">:</mark> Maior complexidade na configuração e gerenciamento.     |
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Prevenção de Perdas Acidentais**</mark><mark style="color:purple;">:</mark> Se um objeto for excluído, ele não é removido permanentemente. Em vez disso, o Amazon S3 coloca um marcador de exclusão no objeto, permitindo que você restaure a versão anterior removendo o marcador. | <mark style="color:purple;">**Rastreamento de Versões**</mark><mark style="color:purple;">:</mark> Facilita o rastreamento de mudanças ao longo do tempo, mantendo um histórico completo das modificações feitas aos objetos.                       |
| <mark style="color:purple;">**Proteção contra Substituições**</mark><mark style="color:purple;">:</mark> Substituir um objeto resulta na criação de uma nova versão do objeto. As versões anteriores permanecem disponíveis para acesso ou restauração.                                                           | <mark style="color:purple;">**Recuperação Simples**</mark><mark style="color:purple;">:</mark> Em caso de falhas de aplicação ou erros humanos, você pode facilmente recuperar uma versão anterior de um objeto, evitando perdas de dados críticas. |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:purple;">**Descrição**</mark>: No estado padrão, o versionamento não está habilitado. Nenhum objeto no bucket tem um ID de versão. Qualquer objeto novo que for carregado substituirá o objeto existente com o mesmo nome. | <mark style="color:purple;">**Descrição**</mark>: O versionamento está habilitado para todos os objetos no bucket. Cada vez que você faz upload de um objeto com o mesmo nome de um objeto existente, o Amazon S3 cria uma nova versão do objeto, mantendo as versões anteriores disponíveis. | <mark style="color:purple;">**Descrição**</mark>: O controle de versão está suspenso para novos objetos. Todos os novos objetos carregados no bucket não terão um ID de versão, mas os objetos existentes que foram carregados antes da suspensão do versionamento manterão suas versões. |
| <mark style="color:green;">**Cenário**</mark>: Ideal para buckets onde o controle de versões não é necessário, e a simplicidade é preferida.                                                                                                  | <mark style="color:green;">**Cenário**</mark>: Útil para casos onde a preservação de versões históricas dos objetos é importante, como backups e registros de mudanças.                                                                                                                       | <mark style="color:green;">**Cenário**</mark>: Adequado para situações onde você quer parar temporariamente de criar novas versões dos objetos, mas ainda quer manter as versões existentes.                                                                                              |
...
| <mark style="color:purple;">**Exemplo**</mark><mark style="color:purple;">:</mark> Você pode configurar uma política de ciclo de vida para transicionar objetos para a classe de armazenamento S3 Standard-IA (Acesso Infrequente) 30 dias após sua criação inicial. Isso é útil para objetos que são frequentemente acessados no início, mas depois passam a ser acessados com menos frequência. | <mark style="color:purple;">**Exemplo**</mark><mark style="color:purple;">:</mark> Após um determinado período de tempo, como um ano, você pode configurar uma ação de expiração para excluir automaticamente os objetos. Isso é útil para conformidade com políticas de retenção de dados ou para evitar o acúmulo desnecessário de dados antigos. |
