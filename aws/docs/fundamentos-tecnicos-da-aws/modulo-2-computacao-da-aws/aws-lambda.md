...
| Execução no Amazon EC2                                                                                                        | Execução em contêineres no Amazon ECS e Amazon EKS                                                                                            | Computação sem servidor na AWS                                                                                                                                                                  |
| ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A AWS é responsável pelo hardware físico.                                                                                     | A AWS gerencia mais do ambiente de contêineres, como implantação dos contêineres em instâncias EC2 e gerenciamento do cluster de contêineres. | Se você optar pela computação sem servidor (como AWS Lambda ou AWS Fargate), a AWS gerencia quase todos os aspectos do ambiente de execução.                                                    |
| Você é responsável pelo sistema operacional convidado, segurança e patches, configuração de rede, segurança e escalabilidade. | Você ainda é responsável por manter as instâncias EC2 subjacentes, incluindo sistema operacional, segurança, patches e configuração de rede.  | Você não precisa gerenciar instâncias EC2 ou clusters de contêineres. A AWS assume responsabilidade pela infraestrutura física, escalabilidade automática e manutenção do ambiente de execução. |
...
| Criação do código-fonte                                                                                                                                                                                    | Configuração da função do Lambda                                                                                                                                                   | Acionadores (Triggers)                                                                                                                                           | Facilidade de gerenciamento                                                                                                                                                                     |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Pode ser desenvolvido do zero.                                                                                                                                                                             | Especifica o tempo de execução, como Python, Node.js, Ruby, Go, Java ou .NET Core, ou pode definir um tempo de execução personalizado.                                             | Determinam quando a função do Lambda será executada em resposta a eventos específicos na AWS.                                                                    | Werner Vogels, CTO da Amazon, destaca que "nenhum servidor é mais fácil de gerenciar do que nenhum servidor", resumindo a conveniência das soluções sem servidor como AWS Fargate e AWS Lambda. |
| Utiliza modelos fornecidos pela AWS.                                                                                                                                                                       | Configuração inclui definições de rede, variáveis de ambiente, alocação de memória, tipo de invocação, permissões de acesso e outras configurações detalhadas conforme necessário. | Integra com outros serviços AWS para automatizar a execução de funções em resposta a chamadas de API, eventos de armazenamento, mensagens de fila, entre outros. | Essas soluções eliminam a necessidade de gerenciar infraestrutura física ou virtual diretamente, permitindo foco total no desenvolvimento de aplicações e na resposta a eventos.                |
